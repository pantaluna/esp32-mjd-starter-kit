## Project Description
This project demonstrates the basics of using the standard NVS driver of the ESP-IDF framework with a custom NVS partition.

Use it to get insights in how to use this driver for Non-Volatile Storage.
