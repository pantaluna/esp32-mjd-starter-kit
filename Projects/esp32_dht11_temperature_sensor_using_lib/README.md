## Project Description
This project demonstrates the basics of using the MJD component "mjd_dht11" for the Aosong DHT11 temperature sensor.

Use it to get insights in how to use this component.

Goto the component "components/mjd_dht11" for installation and usage/wiring instructions, data sheets, FAQ, photo's, etc. for the hardware and software.
