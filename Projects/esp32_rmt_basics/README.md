## Project Description
This project demonstrates the basics of using the standard RMT driver of the ESP-IDF framework.

Use it to get insights in how to define the timings of the RMT driver.

Attach a logic analyzer to the data pin.
